...
const STRINGS = {
  en: {
    ...
    helpExplore: "Explore: ",
    helpFun: "Fun:     ",
    cliHelpFooter: "Tab autocompletes · 'commands' lists everything · 'clear' resets the screen.",
    cliCommands: [
      "Available commands:",
      "",
      "Essential:",
      ...
      "  rss (feed)      Subscribe via RSS / JSON Feed",
      ...
      "  crt [on|off]    Toggle CRT screen effects",
      "",
      "System:",
    ...
    crtUsage: "Usage: crt [on|off]",
    crtOn: "CRT effects on. ✨",
    crtOff: "CRT effects off.",
    crtToggleTitle: "Toggle CRT effects",
    tip: (hint) => `Tip: ${hint}`,
    commandNotFound: [
      "Command not found.",
    ...
    feedTitle: "Subscribe to new posts:",
    feedHint: "Paste either URL into your feed reader.",
    feedRss: "RSS",
    feedJson: "JSON",
    blogRss: "rss ↗",
    neofetchInfo: (user) => [
      ...
      "Host: mxmgorin.dev",
      "Shell: web-tui",
      "Terminal: the one you're reading",
      "Uptime: since 2015",
      "Languages: Rust · Go · C#",
      "Open source: PortMaster contributor",
      "Hobby: handhelds & weird hardware",
  ...
  ru: {
    ...
    helpExplore: "Разделы: ",
    helpFun: "Игры:    ",
    cliHelpFooter: "Tab дополняет · 'commands' покажет всё · 'clear' очистит экран.",
    cliCommands: [
      "Доступные команды:",
      "",
      "Основные:",
      ...
      "  rss (feed)      Подписка через RSS / JSON Feed",
      ...
      "  crt [on|off]    Вкл/выкл CRT-эффекты",
      "",
      "Система:",
    ...
    crtUsage: "Использование: crt [on|off]",
    crtOn: "CRT-эффекты включены. ✨",
    crtOff: "CRT-эффекты выключены.",
    crtToggleTitle: "Вкл/выкл CRT-эффекты",
    tip: (hint) => `Совет: ${hint}`,
    commandNotFound: [
      "Команда не найдена.",
    ...
    feedTitle: "Подписка на новые посты:",
    feedHint: "Вставьте любой из адресов в свою читалку.",
    feedRss: "RSS",
    feedJson: "JSON",
    blogRss: "rss ↗",
    neofetchInfo: (user) => [
      ...
      "Аптайм: с 2015",
      "Языки: Rust · Go · C#",
      "Open source: контрибьютор PortMaster",
      "Хобби: консоли и необычные устройства",
