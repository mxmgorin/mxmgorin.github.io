...
Я разработчик с <b>более чем 7-летним</b> опытом разработки высокопроизводительных, надёжных и поддерживаемых систем.
...
Я работал над серверными сервисами, веб-платформами и десктоп приложениями. Проектировал высоконагруженные системы, схемы баз данных и пайплайны реального времени. Вёл проекты от идеи до релиза, участвовал в планировании, код-ревью и менторстве.
